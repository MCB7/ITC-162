...
$siteKey = "6LeW0LwZAAAAAMmGe157QQ40VBNMuoiks6X5swAp";
$secretKey = "6LeW0LwZAAAAAKMIiS6POqyJOwYEzUTFoDVXYVBg";
date_default_timezone_set('America/Los_Angeles'); #sets default date/timezone for this website
$server = 'www.dreamhost.com';
//end config area ----------------------------------------
...
function loadContact($form,$feedback='')
{
    ...
    if($toAddress=='' || $toAddress == 'morganbligh@icloud.com')
    {
